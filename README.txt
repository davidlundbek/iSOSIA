Instructions for running computational experiments used in
...
This folder contains 1) iSOSIA (version spm-3.4.3) for running the experiments, 2) four model folders (Uniform, Slope, Frost_AT, and Frost_LST), and 3) grids with DEMs and other geo-referenced information.
